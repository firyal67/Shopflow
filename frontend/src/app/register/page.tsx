          ...
          {role === "SELLER" && (
            <>
              <div>
                ...
                {errors.nomBoutique && <p className="text-red-400 text-xs mt-1">{errors.nomBoutique.message}</p>}
              </div>
              <div>
                <label className="block text-sm font-medium text-zinc-300 mb-1">Description de la boutique</label>
